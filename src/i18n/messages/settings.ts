...
export const settings = defineMessages({
  zh: {
    ...
    autoSubmit: {
      title: "自动投递",
      description:
        "开着的时候助手不再停下来等你:填好的申请直接提交,表单里缺的答案由 App 按你的档案、标准答案和经历自行作答。找内推时起草好的消息也直接批准发出。只有登录、创建账号、验证码、缺少的文件和必须亲自完成的题目才会留一张待处理卡。人脉页的 coffee chat 消息不受影响,仍然要你批准。",
      manual: "填好后等我确认",
      manualDescription: "每份申请都在「待确认」卡上等你看一眼再提交;缺答案就出一张待处理卡;内推消息在「内推进行中」卡上等你批准。",
      auto: "全自动:填好直接提交",
      autoDescription: "你忙的时候投递和找内推都不停。自动作答的内容会存进档案的「标准答案」,随时可以改;每次自动提交都会发一条通知。",
      on: "已开启",
  ...
  en: {
    ...
    autoSubmit: {
      title: "Auto-apply",
      description:
        "With this on, the assistant no longer stops for you: a filled application is submitted right away, and any answer missing from the form is written by the App from your profile, standard answers and experience. Referral messages are approved and sent as soon as they are drafted. Only signing in, creating an account, a captcha, a missing file or a step you must do yourself still leaves a to-do card. Coffee-chat messages from the Network page are unaffected and still wait for your approval.",
      manual: "Wait for my confirmation",
      manualDescription: "Every filled application waits on a Confirm card until you look at it; a missing answer becomes a to-do card; referral messages wait for your approval on the referral board.",
      auto: "Fully automatic: submit as soon as it is filled",
      autoDescription:
        "Applying and referral outreach keep going while you are busy. Auto-written answers are saved to your profile's standard answers, where you can edit them; every auto-submission sends a notification.",
      on: "On",
