...
可以直接编辑文本框,[批准发送](先保存编辑再批准)或[拒绝]。措辞原则是「先给后要」:先一句关于对方本人的真话
(来自助手在其主页读到的观察,联系人详情里显示为「助手在主页看到的」)、再一句自己做过的一件具体的事(来自档案页的
经历)、再小小地提请求并给台阶,结尾的感谢不依赖结果;好友申请留言版是「第一次打招呼」,不会以内推请求开头。
